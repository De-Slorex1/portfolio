...
const Main = () => {
        ...
        <main>
                        ...
                        */}
                        ...
                        <div className="row flex responsive_flex">
                                <div>
                                        ...
                                        <div className="u-center-text-contact u-margin-top-huges">
                                                <a href="/works" className="btn btn--cyan">Contact me</a>
                                        </div>
                                ...
                                <div>
                                        <div className="composition padding_pic_adjustment">
                                                ...
                                                <div className="prof_pic">
                                                        <img src="../../profile.png" alt="pic" width={400} />
                                                </div>
                ...
                <Skills name='Experience' skillsPage={true} />
                <div style={{display: 'flex', justifyContent: "space-evenly"}} className="responsive_flex">
                
                        <div className="cards">
                                <Card date="25 October 2025" title="Frontend Developer - Techmaestro" description="Built and optimized web applications for performance and responsiveness, Contributed to frontend architecture and UI improvements" />
                                <Card date="01 November 2025" title="Frontend Web Instructor - Aptech Computer Education" description="Delivered practical, hands-on training to CPISM students in Frontend Web Development, including HTML,
CSS, JavaScript, React.js, and UI/UX principles using Figma, " />
                                <Card date="May 24 2022" title="Fullstack Web Instructor - Zeetech Computer Institute" description="Taught aand mentored students in HTML, CSS, JavaScript, React.js, Node.js, Mongodb and Express.js"  />
                        </div>
                </div>
                ...
                <div className="col-1-of-4">
                        ...
                        I have five years plus experience with react. I also gained vast familiarity with redux-toolkit and developed web applications with react.js.
                        </p>
                        </div>
                </div>
                ...
                <div className="col-1-of-4">
                        ...
                        <path fill="#ffffff" d="M18.974,31.5c0,0.828-0.671,1.5-1.5,1.5s-1.5-0.672-1.5-1.5v-14c0-0.653,0.423-1.231,1.045-1.43 c0.625-0.198,1.302,0.03,1.679,0.563l16.777,23.704C40.617,36.709,44,30.735,44,24c0-11-9-20-20-20S4,13,4,24s9,20,20,20 c3.192,0,6.206-0.777,8.89-2.122L18.974,22.216V31.5z M28.974,16.5c0-0.828,0.671-1.5,1.5-1.5s1.5,0.672,1.5,1.5v13.84l-3-4.227 V16.5z"></path>
                        </svg>
                        </span>
                        <h3 className="heading-tertiary u-margin-bottom-small">next</h3>
                        <p className="feature-box__text"> 
                                I possess over two years of experience working with Next.JS and have successfully developed various web applications, including standard ecommerce platforms, YouTube clones, and more.
                        </p>
                        </div>
                </div>
                <div className="col-1-of-4">
